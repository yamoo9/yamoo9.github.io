;(function(global) {
	...
	// class
  var Perspective3DText = function(container, innerSelector) {
	...
	Perspective3DText.prototype._init = function() {
		this._container.innerHTML = 
			'<'+ this._innerSelector +' class="Perspective3DText_inner">' + 
				this._container.innerHTML + 
			'</'+ this._innerSelector +'>'
		this._inner = this._container.querySelector('.Perspective3DText_inner')
	...
	Perspective3DText.prototype._updateTransformStyle = function(x, y) {
		...
		inner.style.oTransform = 'rotateX(' + x + 'deg) rotateY(' + y + 'deg)'
	}
